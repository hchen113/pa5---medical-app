...
class RecordMealViewController: UIViewController , UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBOutlet weak var meal_name_label: UILabel!
    ...
    override func viewDidLoad() {
        ...
        key_ingredients_textview.layer.borderColor = UIColor(red: 0.9, green: 0.9, blue: 0.9, alpha: 1.0).cgColor
        key_ingredients_textview.layer.borderWidth = 1.0
        key_ingredients_textview.layer.cornerRadius = 5
